...
typedef struct _private_data_t {
    ...
    EXPORT_DECL(int, NSSLInit, void);
    EXPORT_DECL(int, NSSLCreateContext, int32_t unk);
    EXPORT_DECL(int, NSSLAddServerPKI, int32_t context, int index);
    EXPORT_DECL(int, NSSLDestroyContext, int32_t context);
    EXPORT_DECL(int, NSSLFinish, void);
