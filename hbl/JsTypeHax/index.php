...
<html lang="en">
    ...
    <body>
		<img src="logo.png" width="768" height="256">

        <button class="launchButton" type="button" onclick="checkCompatibility()">Launch HBL</button>
        ...
        <div id="information" style="margin: 30px 0;">
            <b>The web exploits used CAN in rare cases lock-up your Wii U while attempting to launch homebrew. If that happens, hold the power button for a few seconds and try it again.</b><br>
            <br>
            <b>All modifications done are fully temporary and after you exit the homebrew, no traces are left.</b>
        </div>
        ...
        <div id="credits">
			...
			<div>
				<b>Dumpling Launcher (basis for this)</b>
				<p> - Crementif</p>
				<p> - Emiyl</p>
        </div>
    </body>
